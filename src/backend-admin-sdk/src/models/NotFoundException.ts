...
export interface NotFoundException {
     ...
     */
    code: NotFoundExceptionCodeEnum;
    /**
     * 
     * @type {string}
     * @memberof NotFoundException
 ...
 * @export
 */
export const NotFoundExceptionCodeEnum = {
...
export type NotFoundExceptionCodeEnum = typeof NotFoundExceptionCodeEnum[keyof typeof NotFoundExceptionCodeEnum];
