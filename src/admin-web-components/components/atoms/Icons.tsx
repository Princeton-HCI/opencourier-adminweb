...
export const Icons = {
  ...
  bank: ({ className, ...props }: IconProps) => (
    <svg
      ...
      {...props}
    >
      <path fill="#e4ecec" d="M0 0h32v32H0z"></path>
      <path
        fillRule="evenodd"
        clip-rule="evenodd"
  ...
  bankToken: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="14" viewBox="0 -1 5 7" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
        d="M.5 1c.268 0 .5.222.5.495v2.01C1 3.785.776 4 .5 4a.503.503 0 0 1-.5-.495v-2.01C0 1.215.224 1 .5 1zM2 0h1v2H2V0zm0 3h1v2H2V3z"
      ></path>
    </svg>
  ),
  stripe: (props: IconProps) => (
    <svg viewBox="0 0 60 25" xmlns="http://www.w3.org/2000/svg" width="60" height="25" {...props}>
      <path
        fill=""
